...
После своего открытия, колесо обозрения стало новой достопримечательностью Астаны и завоевало сердца жителей и гостей города. Прокатившись на колесе обозрения, Вы сможете насладиться отличными видами на столицу с высоты птичьего полета.''',
     'price': 'None',
     'start': '10:00',
     'end': '20:00', 'address': 'Астана, Коргалжинское шоссе, 2',
     'phone':' +7 (7172) 79-04-39',
    ...
    'transport': '№ 10 12 26'},
    {
        ...
        'description': '''Идея создания единственного в своем роде парка динозавров принадлежала президенту РК Н.А. Назарбаеву. Открытие динопарка состоялось 6 июля 2008 года – в День столицы (Астаны), именно в этот праздничный день «Джунгли» впервые открыли свои двери для посетителей.
